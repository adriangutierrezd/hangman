...
const LEFT_ARM = (
    <div style={{ width: '100px', height:'10px', position: 'absolute', top: '150px', right: '10px', background: 'black', rotate: '30deg', transformOrigin: 'right bottom' }} />
)
...
const LEFT_LEG = (
    <div style={{ width: '100px', height:'10px', position: 'absolute', top: '210px', right: 0, background: 'black', rotate: '-60deg', transformOrigin: 'right bottom' }} />
)

const BODY_PARTS = [HEAD, BODY, RIGHT_ARM, LEFT_ARM, RIGHT_LEG, LEFT_LEG]

type HangmanDrawingProps = {
    readonly numberOfGuesses: number
}
